...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || ' Hi，我是一个打工人,欢迎来到我的空间🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'comecoo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的打工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://comecoo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'comecoo@yeah.net', // 邮箱地址 例如mail@tangly1024.com
  ...
  FACEBOOK_PAGE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE || https://www.facebook.com/profile.php?id=61553729121894, // Facebook Page 的連結 e.g https://www.facebook.com/tw.andys.pro
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '11110000', // 备案号 闽ICP备XXXXXXX
 ...
 // WEB_WHIZ_CHAT_BOT_ID: process.env.NEXT_PUBLIC_WEB_WHIZ_CHAT_BOT_ID || 6552e0fe3037b48027a447f3 // 在后台获取ID
  ...
  MUSIC_PLAYER_AUTO_PLAY:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_AUTO_PLAY || true, // 是否自动播放，不过自动播放时 常不生效（移动设备不支持自动播放）
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '3079778383', // 对应歌单的 id
...
*/
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个自由打工人的站点', // 站点描述，被notion中的页面描述覆盖
