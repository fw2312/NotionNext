...
const BLOG = {
  ...
  SINCE: 1989, // e.g if leave this empty, current year will be used.
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://comecoo.top', // 网站地址
  ...
  FACEBOOK_PAGE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE || https://www.facebook.com/profile.php?id=61553118437295, // Facebook Page 的連結 e.g https://www.facebook.com/tw.andys.pro
