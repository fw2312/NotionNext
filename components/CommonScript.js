...
const CommonScript = () => {
  return (<>
    ...
    {JSON.parse(BLOG.MUSIC_PLAYER) && JSON.parse(BLOG.MUSIC_PLAYER_METING) && <script async data-id="8115745167" id="chatling-embed-script" type="text/javascript" src="https://chatling.ai/js/embed.js"></script>}
  </>)
}
